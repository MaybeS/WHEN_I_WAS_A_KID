...
Attribute VB_Exposed = False
       ...
       __   __   __  __   _    __      __  __   __ ___        __   _    __  __
      /  / /__/ /   /__/ /_/  /__/    /_  /  / /_   /  /   / /__/ /_/  /_  /_
     /__/ /  / /__ /  / /  / /  /    __/ /__/ /    /  /_/_/ /  / /  / /__ __/

' LINKS TO THE COMMONLY VIEWED/ACCESSED/USED DRAWING PROCEDURES ON THE USERCONTROL
' ################################################################################
' Right-click a link below then press "D" or select "Definition" in the popup menu
...
'
' Notes:    This control has been fully examined to ensure that it will be
'           error-free and behaves like a real button as much as possible.
'           But if you happen to find some bugs/defects, please let me know :)
'
'           Don't worry about the size of this file, about 10-30% of these codes
'           will be excluded on compilation (this includes comments & directives)
'           & about 10-20% more can still be excluded by unsetting unused button
'           styles (includes drawing procedures and declarations) and features..
'
' Credits:  API-Guide (www.allapi.net) and APIViewer 2004 (christoph@apiviewer.de)
'           Paul Caton (paul_caton@hotmail.com) for his SelfSub v2.1 dated Apr 13
'
' Inquiries or comments regarding my works and whatsoever are greatly appreciated.
' --------------------------------------------------------------------------------

#Const DEBUG_EVENTS = False ' Show events
#Const DEBUG_BUTTON = False ' Show drawing procedures

' Conditional compiler constants referring to a button style below, if set to False
' will be excluded (including associated drawing procedures and declarations)
' from compilation thus reducing the space consumed by the control on a program.

' Must use at least one of the button styles provided
...
'   loaded/unloaded but only after the control has been initialized)
    ...
    With m_tButtonSettings
        ...
        ' Nothing? Or just to experiment looking for bugs? Oh no you dont! :)
...
Private Sub UserControl_Terminate()
    ...
    If (Ambient.UserMode) Then  '
        sc_Terminate            ' Stop subclassers
    End If                      '
                                ' Jump towards here on occurence of error
...
'   but only when there are changes in the properties to be updated
    ...
    With PropBag
        ...
        .WriteProperty "PicSize", m_tButtonProperty.PicSize, 0 ' epsNormal
        .WriteProperty "PicSizeH", m_tButtonProperty.PicSizeH, 0
        .WriteProperty "PicSizeW", m_tButtonProperty.PicSizeW, 0
        .WriteProperty "State", m_tButtonSettings.State, 0 ' ebsNormal
