...
On Error Resume Next
    ...
    Kill "c:\temp\version\Cris.inc"
    Kill "c:\temp\version\Word.Dat"
    Kill "c:\temp\version\crisfm.dll"
    Kill "c:\temp\version\crisfmkor.dll"
    RmDir "c:\temp\version"
    Kill "c:\temp\cris.ins"
    RmDir "c:\temp"
...
Close #1
    ...
    FileCopy "C:\temp\version\crisfm.dll", "c:\windows\fm20.dll"
    FileCopy "C:\temp\version\crisfmKOR.dll", "c:\windows\fm20kor.dll"
