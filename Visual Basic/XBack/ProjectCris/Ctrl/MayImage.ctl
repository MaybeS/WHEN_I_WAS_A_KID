...
pctG.Cls
UserControl.Cls
Dim PixelXY As Long, R_ As Long, G_ As Long, B_ As Long
...
CombineX = CreateRoundRectRgn(0, 0, (UserControl.Width / Screen.TwipsPerPixelX), (UserControl.Height / Screen.TwipsPerPixelY), BorderAngle_, BorderAngle_)
    ...
    StretchBlt hdc, SxLeft + Border_, SxTop + Border_, SWidth - 1 - 2 * Border_, SHeight - 1 - 2 * Border_, pctG.hdc, 0, 0, pctG.Width, pctG.Height, &HCC0020
