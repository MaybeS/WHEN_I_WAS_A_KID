================================================================================
              MFC 라이브러리 : CXImageTest 프로젝트 개요
================================================================================

응용 프로그램 마법사를 사용하여 CXImageTest 응용 프로그램을 만듭니다. 이 응용 
프로그램에서는 기본적인 MFC 사용 밥법과 응용 프로그램 작성 방법을 설명합니다.

이 파일에는 CXImageTest 응용 프로그램을 구성하는 각 파일에 대한 개요가 포함되어
있습니다.
...
CXImageTest.h
    ...
    특정 헤더가 포함되며 CCXImageTestApp 응용 프로그램 클래스가 선언됩니다.

CXImageTest.cpp
    CCXImageTestApp 응용 프로그램 클래스를 포함하는 주 응용 프로그램의 소스 파일입니다.
...
res\CXImageTest.ico
    ...
    이 아이콘은 주 리소스 파일인 CXImageTest.rc에 포함됩니다.
...
res\Toolbar.bmp
    ...
    리소스 편집기를 사용하여 도구 모음 비트맵을 편집하고 CXImageTest.rc의
    IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음 단추에 추가합니다.
/////////////////////////////////////////////////////////////////////////////

응용 프로그램 마법사에서 단일 문서 종류 및 단일 뷰를 만듭니다.

CXImageTestDoc.h, CXImageTestDoc.cpp - 문서
    CCXImageTestDoc 클래스를 포함하는 파일입니다. 이 파일을 편집하여
    특정 문서 데이터를 추가하고 파일을 저장 및 로드합니다
    (CCXImageTestDoc::Serialize 사용).
CXImageTestView.h, CXImageTestView.cpp - 문서 뷰
    CCXImageTestView 클래스를 포함하는 파일입니다.
    CCXImageTestView 개체를 사용하여 CCXImageTestDoc 개체를 볼 수 있습니다.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    미리 컴파일된 헤더 파일(PCH) CXImageTest.pch 및 미리 컴파일된
