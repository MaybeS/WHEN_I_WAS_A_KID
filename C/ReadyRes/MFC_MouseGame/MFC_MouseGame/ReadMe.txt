================================================================================
    MFC 라이브러리 : MFC_MouseGame 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 MFC_MouseGame 응용 프로그램을 
만들었습니다.  이 응용 프로그램은 MFC(Microsoft Foundation Classes)의
기본적인 사용법을 보여 주며 응용 프로그램 작성을 위한 출발점을 제공합니다.

이 파일에는 MFC_MouseGame 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.

MFC_MouseGame.vcproj
...
MFC_MouseGame.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CMFC_MouseGameApp 응용 프로그램
    클래스를 선언합니다.

MFC_MouseGame.cpp
    응용 프로그램 클래스 CMFC_MouseGameApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\MFC_MouseGame.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다.  이 아이콘은
    주 리소스 파일인 MFC_MouseGame.rc에 의해 포함됩니다.

res\MFC_MouseGame.rc2
...
res\Toolbar.bmp
    ...
    MFC_MouseGame.rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음
    단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////

응용 프로그램 마법사에서 하나의 문서 형식과 하나의 뷰가 만들어집니다.

MFC_MouseGameDoc.h, MFC_MouseGameDoc.cpp - 문서
    이 파일에는 CMFC_MouseGameDoc 클래스가 들어 있습니다.  이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CMFC_MouseGameDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

MFC_MouseGameView.h, MFC_MouseGameView.cpp - 문서 뷰
    이 파일에는 CMFC_MouseGameView 클래스가 들어 있습니다.
    CMFC_MouseGameView 개체는 CMFC_MouseGameDoc 개체를 보는 데 사용됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 MFC_MouseGame.pch와
