...
MpM.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CMpMApp 응용 프로그램
    클래스를 선언합니다.

MpM.cpp
    응용 프로그램 클래스 CMpMApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
MpMDlg.h, MpMDlg.cpp - 대화 상자
    이 파일에는 CMpMDlg 클래스가 들어 있습니다.  이 클래스는
    응용 프로그램의 주 대화 상자 동작을 정의합니다.  대화 상자의 템플릿은
    Microsoft Visual C++에서 편집할 수 있는 MpM.rc에 있습니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 MpM.pch와
