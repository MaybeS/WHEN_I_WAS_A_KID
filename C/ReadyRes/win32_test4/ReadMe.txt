========================================================================
    Win32 응용 프로그램 : win32_test2 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 win32_test2 응용 프로그램을 만들었습니다.  
이 파일에는 win32_test2 응용 프로그램을 구성하는 각각의 파일에
...
win32_test2.ico
    ...
    해당 아이콘은 기본 리소스 파일인 win32_test2.rc에 의해 포함됩니다.

small.ico
    아이콘 파일이며, 응용 프로그램 아이콘의 더 작은 버전(16x16)이
    들어 있습니다. 해당 아이콘은 기본 리소스 파일인
    win32_test2.rc에 의해 포함됩니다.

/////////////////////////////////////////////////////////////////////////////
기타 표준 파일:

StdAfx.h 및 StdAfx.cpp는
    win32_test2.pch라는 이름의 PCH(미리 컴파일된 헤더) 파일과
